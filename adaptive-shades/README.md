...
Adaptive Shades Pro automates vertical blackout or zebra shades using the solar-geometry strategy outlined in _Energies 13(7):1731_. It keeps setup minimal—pick your shade, set the window orientation, and choose comfort bounds—while balancing glare control, passive solar gain, and cooling load.
...
- B. K. (2020). _The Control of Venetian Blinds: A Solution for Reduction of Energy Consumption Preserving Visual Comfort,_ **Energies 13(7):1731**. The blueprint implements the direct/diffuse classification, temperature bands, and slat-angle equations (including Eq. 8) adapted for Home Assistant covers.
