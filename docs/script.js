...
(function() {
    ...
    // Console easter egg
    console.log('%c Home Assistant Blueprints ', 'background: linear-gradient(135deg, #3b82f6, #8b5cf6); color: white; padding: 10px 20px; font-size: 16px; font-weight: bold; border-radius: 5px;');
