...
// This package contains type-safe extraction utilities, path building helpers, and common
// validation patterns used across all validator components.
package common
...
// CollectInputRefs extracts !input reference names from a string.
